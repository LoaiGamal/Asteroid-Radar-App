...
class AsteroidsAdapter(private val clickListener: AsteroidListener) :
    ...
    class ViewHolder private constructor(private val binding: AsteroidsListItemBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = AsteroidsListItemBinding.inflate(layoutInflater, parent, false)
